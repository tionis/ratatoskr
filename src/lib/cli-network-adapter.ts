...
export class RatatoskrNetworkAdapter extends NetworkAdapter {
  ...
  constructor(options: RatatoskrNetworkAdapterOptions) {
    ...
    if (options.onConnecting) this.onConnecting = options.onConnecting;
    if (options.onConnected) this.onConnected = options.onConnected;
    if (options.onDisconnected) this.onDisconnected = options.onDisconnected;
    if (options.onAuthError) this.onAuthError = options.onAuthError;
  }
  ...
  connect(peerId: PeerId, peerMetadata?: PeerMetadata): void {
    this.peerId = peerId;
    if (peerMetadata) this.peerMetadata = peerMetadata;
    this.doConnect();
  }
